...
- **AI 点评:** 雷达全局定位直接服务 SLAM 和多会话定位，和机器人导航、状态估计高度相关。
...
- **AI 点评:** 分布式多机器人定位与一致性状态估计直接支撑规划控制，和导航及状态估计方向高度相关。
...
- **AI 点评:** Isaac Sim/Isaac Lab 事件相机插件有利于机器人感知仿真与数据生成，但尚未直接落到 locomotion 或导航策略。
...
- **AI 点评:** 面向 LiDAR 感知的实时调度并服务自动驾驶导航，和机器人感知-导航耦合较相关但非足式/轮足平台。
...
- **AI 点评:** 面向 UAV 的长程视觉语言导航并考虑低延迟飞控，和自主导航相关但仍偏 VLN 仿真框架。
...
## 📊 今日统计
- 总抓取: 96 篇 | 通过初筛: 28 篇 | 精选: 5 篇 (含 LLM 精筛)
